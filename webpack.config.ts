...
<<<<<<< HEAD
      if (request.startsWith('sillytavern/')) {
        ...
        // script.js is at root (/script.js) → 5 levels up
        // everything else is at /scripts/ → 4 levels up
        if (name === 'script') {
          return callback(null, 'module-import ../../../../../script.js');
        } else {
          return callback(null, 'module-import ../../../../' + name + '.js');
        }
      }
